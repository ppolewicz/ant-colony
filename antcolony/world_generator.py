...
class SimpleWorldGenerator(AbstractWorldGenerator):
    ...
    def __init__(self, number_of_dimensions, point_generator, edge_generator, *args, **kwargs):
    ...
    def generate(self):
        ...
        edges = set(self.edge_generator.generate_and_register(points, *self.args, **self.kwargs))
